...
import org.example.linkedIn.*;

import java.util.List;

public class LinkedInDemo {

    public static void runLinkedInDemo() {
        ...
        // Post a job listing
        linkedInService.postJobListing("Software Developer", "Discord", "AI Engineer", "San Francisco");
        linkedInService.postJobListing("Software Developer", "Airbnb", "Full Stack Developer", "Seattle");
        ...
        // Get notifications
        List<Notifications> notifications = linkedInService.getAllNotification(user2.getId());
